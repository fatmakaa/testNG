...
//       Click on "Add Customer" button
  ...
  //        Fill inputs and click on "Add Customer" form
        ...
        for (int i =0; i<5; i++) {
            ...
            xyzBankManagerPage.submitButton.click();
...
//        Type 100 into "Amount to be Deposited" input
        ...
        xyzBankCustomerPage.depositInput.sendKeys("1000");

//        Click on "Deposit"(Submit) button
        xyzBankCustomerPage.depositSubmitButton.click();

//        Assert that "Deposit Successful" is displayed
       // assertTrue(xyzBankCustomerPage.depositSuccessfulMessage.getText().contains("Deposit Successful"));
...
//        Assert that "Transaction  Successful" is displayed
        assertTrue(xyzBankCustomerPage.transactionSuccessfulMessage.getText().contains("Transaction successful"));
...
//        Click on each "Delete" button
     ...
     xyzBankManagerPage.deleteButton.forEach(WebElement::click); //instead of creating loop .forEach(WebElement::click)

//        Count table row numbers

//        Assert that number of customers is 0
        assertTrue(xyzBankManagerPage.deleteButton.isEmpty());
