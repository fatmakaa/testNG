...
// Data provider method to get the employee credentials
   ...
   // Data Provider to get the employee credentials from the EXCEL SHEET
    ...
    public Object [][] excelEmployeeData(){
        String excelPath = "/Users/fatmakarmis/IdeaProjects/mytestNGproject/resources/data_sheet.xlsx";
   ...
   @DataProvider
    public Object[][] medunnaCredentials() {
      ...
      //  };
       ...
       ExcelUtils excelUtils = new ExcelUtils("/Users/fatmakarmis/IdeaProjects/mytestNGproject/resources/medunna_credentials.xlsx","medunna_credentials");
